...
--
-- Host: localhost
-- Generation Time: Jan 25, 2020 at 04:01 AM
...
INSERT INTO `buyer_reg` (`buyer_id`, `market_id`, `name`, `state`, `city`, `mobile`, `latitude`, `longitude`, `address`, `email`) VALUES
('113578bddf77548d00ed55d8917d54975fc9f045', '8a47f7fd4c97d89fcd55b0e1a41ea46de7b802f9', 'MKCE', 'Tamil Nadu', ' Namakkal ', 3809317650, '13.128999710083008', '77.6050033569336', 'Namakkal', 'kamalnathlp@yopmail.com'),
('37d0e9a823ca7d3ecfcf78b4adfddcb4eb786b86', '8a47f7fd4c97d89fcd55b0e1a41ea46de7b802f9', 'Kamalnath LP', 'Andhra Pradesh', ' Achampet ', 9443385464, '13.128999710083008', '77.6050033569336', '7/8A, PUDUR KATTU KOTTAI', 'kamalnathlp@gmail.com');
...
CREATE TABLE `farmer_info` (
  ...
  `farmer_type` varchar(30) NOT NULL,
  `farmer_email_id` varchar(50) NOT NULL,
  `farmer_date_of_birth` date NOT NULL,
  `farmer_phone_number` int(10) NOT NULL,
  `password` varchar(100) NOT NULL,
  `farmer_district` varchar(30) NOT NULL,
  `farmer_state` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `farmer_info` (`farmer_id`, `farmer_name`, `farmer_type`, `farmer_email_id`, `farmer_date_of_birth`, `farmer_phone_number`, `password`, `farmer_district`, `farmer_state`) VALUES
(1, 'testname', 'Small', 'temp@gmail.com', '2020-01-14', 2135467981, '123456', 'Karur', 'Tamilnadu'),
(2, 'temp', 'Medium', '123@gmail.com', '0000-00-00', 1234567891, '123', 'Karur', 'Tamilnadu'),
(6, 'Sasikumar', 'Medium', 'thisismyinternetid@gmail.com', '1999-05-18', 2147483647, '123456789', 'Karur', 'TN'),
(7, 'kamal', 'Medium', 'kamal@gmail.com', '1568-11-15', 1534567891, '123', 'Karur', 'TN');

-- --------------------------------------------------------

--
-- Table structure for table `farmer_stock`
--
...
--
-- Dumping data for table `farmer_stock`
--

INSERT INTO `farmer_stock` (`farmer_id`, `product_name`, `stock_qty`) VALUES
(1, 'Onion', 150),
(1, 'Sugarcane', 16),
(1, 'Sugarcane', 16),
(1, 'Rice', 15616),
...
INSERT INTO `market_type` (`market_id`, `market_type`) VALUES
('0c55b41b72b2a68faff29a506d4a84f6f1c86e91', 'Industries'),
('fe8f54b7c4480946ea6b36cdd499fdf77016940c', 'OrdConsumer'),
('8a47f7fd4c97d89fcd55b0e1a41ea46de7b802f9', 'RetailCustomer');
...
INSERT INTO `product_names` (`product_id`, `product_name`, `ampc_price`) VALUES
(1, 'Rice', 55),
(2, 'Onion', 65),
(3, 'coconut', 10),
(4, 'Tomato', 30),
...
INSERT INTO `review` (`review_id`, `farmer_id`, `product_name`, `product_review`) VALUES
(1, 1, '1', 'Good'),
(2, 1, '1', 'Nice'),
(3, 1, '2', 'Very Good');
...
CREATE TABLE `service_provider_details` (
  ...
  `provider_phoneNumber` varchar(20) NOT NULL,
...
INSERT INTO `service_provider_details` (`provider_id`, `provider_name`, `service_name`, `provider_mail`, `provider_phoneNumber`, `password`) VALUES
(1, 'Hari', 'HRS', 'hari@gmail.com', '9876543210', '123498765');
...
CREATE TABLE `transport` (
  ...
  `point_2` varchar(50) NOT NULL,
  `point_3` varchar(50) NOT NULL,
  `point_4` varchar(50) NOT NULL,
...
INSERT INTO `transport` (`provider_id`, `source`, `point_2`, `point_3`, `point_4`, `destination`, `amount`) VALUES
(1, 'Chennai', 'Bangalore', 'Chennai', 'Karur', 'Pongal', 1000),
(1, 'Krr', 'kochin', 'karur', 'nepal', '1256', 1000),
(1, 'Krr', 'kochin', 'karur', 'nepal', '1256', 1000),
(2, 'Trichy', 'karur', 'namakkal', 'salem', 'banglore', 1000),
(2, 'Erode', 'Rasipuram', 'Attur', 'Vilupuram', 'Chithambaram', 1000),
(3, 'Chennai', 'salem', 'namakkal', 'karur', 'Pongal', 1000),
(1, '', '', '', '', '', 1000);
...
ALTER TABLE `market_type`
  ...
  ADD UNIQUE KEY `market_type` (`market_type`);
...
--
-- Constraints for table `buyer_reg`
--
ALTER TABLE `buyer_reg`
  ADD CONSTRAINT `relation` FOREIGN KEY (`market_id`) REFERENCES `market_type` (`market_id`);
COMMIT;
